...
class Migration13_14Test {
    ...
    fun migration13_14_preservesExistingMetahistoryData() {
        ...
        val database = Room.databaseBuilder(context, LiftInsightDatabase::class.java, dbName)
            .addMigrations(LiftInsightDatabase.MIGRATION_13_14, LiftInsightDatabase.MIGRATION_14_15, LiftInsightDatabase.MIGRATION_15_16, LiftInsightDatabase.MIGRATION_16_17, LiftInsightDatabase.MIGRATION_16_17)
    ...
    fun migration13_14_createsMetahistoryIndexes() {
        ...
        val database = Room.databaseBuilder(context, LiftInsightDatabase::class.java, dbName)
            .addMigrations(LiftInsightDatabase.MIGRATION_13_14, LiftInsightDatabase.MIGRATION_14_15, LiftInsightDatabase.MIGRATION_15_16, LiftInsightDatabase.MIGRATION_16_17)
            .allowMainThreadQueries()
            .build()
