#import "styles/set-paper-page.typ": show-mainbody, show-paper-footer, show-paper-header, show-paper-page-size
#import "styles/set-heading.typ": show-heading
#import "styles/set-figure.typ": show-figure
#import "styles/set-code.typ": show-code

#import "utils/ziti.typ": heiti, songti, zh, zihao
...
#import "pages/supplementary.typ": acknowledgements, appendices, conclusion, references, supplematry-page
...
#let paper(
  ...
  // 生成原创性声明
  // if declare != none {
  //   if declare { declaration(twoside: twoside, anonymous: anonymous) } else {
  //     declaration_typst(twoside: twoside, anonymous: anonymous)
  //   }
  // }
  // 设置文档显示样式：
